...
if [ "$var" == "$expected_build" ] ; then
    ...
    # Change directory to NTNX-local-ds
    cd /vmfs/volumes/NTNX-local-ds*/
    ...
    esxcli software vib install -d /vmfs/volumes/NTNX-local-ds*/VMware-ESXi-7.OU31-20842708-depot.zip
